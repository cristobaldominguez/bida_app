class PlantsController < ApplicationController
  ...
  def show
    ...
    @tasks = @task_lists.present? ? @task_lists.last.tasks.sort : []
  ...
  def plant_params
    params.require(:plant).permit(
      ...
      :logbook_bf_responsible_id, :logbook_bf_supervisor_id, :logbook_company_responsible_id, unit_number: [], high_season: {}, system_size: [],
