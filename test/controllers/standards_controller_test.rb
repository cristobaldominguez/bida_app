...
class StandardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create standard" do
    assert_difference('Standard.count') do
      post standards_url, params: { standard: { active: @standard.active, option_id: @standard.option_id, plant_id: @standard.plant_id } }
    end
  ...
  test "should update standard" do
    patch standard_url(@standard), params: { standard: { active: @standard.active, option_id: @standard.option_id, plant_id: @standard.plant_id } }
